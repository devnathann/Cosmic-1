...
use Closure;
use Library\Validate\Rules\Interfaces\BeforeValidate;
use Library\Validate\Rules\Interfaces\ModifyValue;
use Library\Validate\Rules\Required;
...
class Validation
{
    ...
    public function isSuccess(): ErrorBag
    {
        if(!empty($this->errors->all())) {
