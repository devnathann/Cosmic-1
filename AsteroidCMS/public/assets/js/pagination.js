(function($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildItem: function(type, page) {
            ...
            $itemContainer.append($itemContent.attr('href', this.options.pageUrl + this.makeHref(page)).addClass(this.options.anchorClass).html(itemText));
