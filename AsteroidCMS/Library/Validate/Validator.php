...
class Validator
{
     ...
     * @return void
     */
    public function __construct($postHandler = null, array $messages = [])
    {
    ...
    {
        $validation = $this->make($this->posthandler, $rules, $messages);
        $validation->validate();
        return $validation;
    }
    ...
    protected function registerBaseValidators()
    {
        $baseValidator = [
            ...
            'figure'                    => new Rules\Figure,
            'pattern'                   => new Rules\Pattern,
